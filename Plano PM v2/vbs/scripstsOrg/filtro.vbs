...
If Not IsObject(application) Then
 ...
 session.findById("wnd[0]/usr/txtRMIPM-WARPL").text = equipNumber & "-F"
 session.findById("wnd[0]/usr/cmbRMIPM-MPTYP").key = "ZT"
 session.findById("wnd[0]/usr/txtRMIPM-WARPL").caretPosition = 10
 session.findById("wnd[0]").sendVKey 0
 session.findById("wnd[0]/usr/subSUBSCREEN_HEAD:SAPLIWP3:6000/txtRMIPM-WPTXT").text = "TROCA DE FILTRO-" & equipNumber
 ...
 session.findById("wnd[0]/usr/subSUBSCREEN_MITEM:SAPLIWP3:8002/tabsTABSTRIP_ITEM/tabpT\11/ssubSUBSCREEN_BODY2:SAPLIWP3:8022/subSUBSCREEN_MAINT_ITEM_TEXT:SAPLIWP3:6005/txtRMIPM-PSTXT").text = "TROCA DE FILTRO-" & equipNumber
 session.findById("wnd[0]/usr/subSUBSCREEN_MITEM:SAPLIWP3:8002/tabsTABSTRIP_ITEM/tabpT\11/ssubSUBSCREEN_BODY2:SAPLIWP3:8022/subSUBSCREEN_ITEM_1:SAPLIWO1:0100/ctxtRIWO1-EQUNR").setFocus
 session.findById("wnd[0]/usr/subSUBSCREEN_MITEM:SAPLIWP3:8002/tabsTABSTRIP_ITEM/tabpT\11/ssubSUBSCREEN_BODY2:SAPLIWP3:8022/subSUBSCREEN_ITEM_1:SAPLIWO1:0100/ctxtRIWO1-EQUNR").caretPosition = 10
 session.findById("wnd[0]").sendVKey 0
